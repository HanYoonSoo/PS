...
//        for(int i = 0; i < N; i++){
//            System.out.print(guilty[i] + " ");
//            System.out.print(isDied[i] + " ");
//        }
//        System.out.println();

//        System.out.println(day + " " + alive + " " + count);
...
//                System.exit(0);
                ...
                isDied[maxIdx] = true;
//                System.out.println(maxIdx + " " + (count) + " " + alive);
            ...
            for(int i = 0; i < N; i++){
                if(!isDied[i] && i != mafia){
                    ...
                    isDied[i] = true;
//                    System.out.println(i + " " + (count + 1) + " " + alive);
